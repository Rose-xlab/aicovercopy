//C:\Users\mukas\Downloads\project-bolt-sb1-guerg2d9\project\app\dashboard\billing\page.tsx
"use client";
...
                            </td>
                            <td className="py-3 px-2 text-sm text-right">
                                {/* FIX: Changed 'success' to 'default' as it's a valid variant for the Badge component. */}
